...
// Type: ArincReader.General.Utilities
...
namespace ArincReader.General
{
    public static class Utilities
    {
        ...
        public static string GetResource(string resourceName) => new ResourceManager("ArincReader.ResourcesFpa", typeof(Utilities).GetTypeInfo().Assembly).GetString(resourceName);
