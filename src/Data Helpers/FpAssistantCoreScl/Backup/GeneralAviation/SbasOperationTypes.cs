...
// Type: FpAssistantCore.GeneralAviation.SbasOperationTypes
...
{
  public enum SbasOperationTypes : byte
  {
    [Description(Text = "0 - Straight-in approach procedure including offset procedures")] StraightInOffsetProcedure,
    [Description(Text = "1 - Code reserved for future definition")] FutureDefinition1,
    [Description(Text = "2 - Code reserved for future definition")] FutureDefinition2,
